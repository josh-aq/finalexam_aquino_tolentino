                        ...
                        <form action="{{ route('employee.store') }}" method="POST">
                            ...
                            <div class="row card-body col-12">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control g-2" id="lname" name="lname"
                                        placeholder="Enter your Lastname" require>
                                </div>
                                <div class="form-group col-6">
                                    <label for="exampleInputPassword1">Middlename</label>
                                    <input type="text" class="form-control g-2" id="mname" name="mname"
                                        placeholder="Enter your Middlename" require>
                                </div>
                                @error('lname')
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control" id="add" name="add"
                                        placeholder="House No. Street Name, Brgy, City">
                                </div>
                                @error('address')
